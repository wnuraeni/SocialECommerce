...
<!-- Styles -->
<link rel="stylesheet" href="<?php echo base_url('css/back_end')?>/bootstrap.css" type="text/css" /><!-- Bootstrap -->
<link href="<?php echo base_url('css/back_end')?>/fullcalendar.css" rel="stylesheet" /><!-- Full calendar -->
<link href="<?php echo base_url('css/back_end')?>/fullcalendar.print.css" rel="stylesheet" media="print" /><!-- Full Calendar -->
<link href="<?php echo base_url('css/back_end')?>/jquery.mCustomScrollbar.css" rel="stylesheet" /><!-- Custom Scroll Bar -->
<link rel="stylesheet" href="<?php echo base_url()?>/font-awesome/css/font-awesome.css" type="text/css" /><!-- Font Awesome -->
<link rel="stylesheet" href="<?php echo base_url('css/back_end')?>/style.css" type="text/css" /><!-- Style -->

<link rel="stylesheet" href="<?php echo base_url('css/back_end')?>/responsive.css" type="text/css" /><!-- Responsive Style -->

<!-- Script -->
<script src="<?php echo base_url('js/back_end')?>/jquery.min.js"></script><!-- Jquery -->
<script src="<?php echo base_url('js/back_end')?>/jquery.mCustomScrollbar.concat.min.js"></script><!-- Scroll Bar -->
<script type="text/javascript"  src="<?php echo base_url('js/back_end')?>/bootstrap.js"></script><!-- Bootstrap -->
<script type="text/javascript"  src="<?php echo base_url('js/back_end')?>/script.js"></script><!-- Script -->
</head>
...
<div class="wrapper">
	<header>
		<div class="logo">
			<img src="<?php echo base_url('images/back_end')?>/logo.png" alt="" />
		</div><!-- Logo -->
		<div class="welcome-user">
			<img src="<?php echo base_url('images/back_end')?>/user.png" alt=""/>
                        <span>Administrator</span> <br>

		</div>

                <div>
                    <p><button onclick=" window.location.href='http://localhost/social_commerce/admin/account/logout';"><?php echo 'Logout'?></button></p>
                </div>
		...
		<div class="social-statistics">
			<h4 class="headings"><i class="icon-twitter"></i>Social Statistics</h4>
				<div class="social-details">
					<img src="<?php echo base_url('images/back_end')?>/fb.jpg" alt="" />
					<span>530,893</span>
					<p>Total Facebook Likes</p>
				</div>

				<div class="social-details">
					<img src="<?php echo base_url('images/back_end')?>/twitter.jpg" alt="" />
					<span>17,812</span>
					<p>Total Twitter Tweets</p>
				</div>

				<div class="social-details">
					<img src="<?php echo base_url('images/back_end')?>/rss.jpg" alt="" />
					<span>2,159</span>
					<p>Total Rss</p>
				</div>
		</div>
		...
		<div class="new-files">
			...
			<ul>
				...
				<li>
					<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
					<a title="" href="#"><img src="<?php echo base_url('images/back_end')?>/email-thumb.png" alt="" />Re : John Doe</a>

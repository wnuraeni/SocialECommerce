...
<script src="<?php echo base_url('js/backend')?>/fullcalendar.min.js"></script> <!-- Full Calendar -->
...
<script src="<?php echo base_url('js/backend')?>/jquery.nicescroll.min.js"></script>
<script src="<?php echo base_url('js/backend')?>/intro.js"></script>
<script src="<?php echo base_url('js/backend')?>/header-line-chart.js"></script>
<script src="<?php echo base_url('js/backend')?>/jquery.flot.min.js"></script><!-- Chart
<script src="<?php echo base_url('js/backend')?>/flot-chart-header.js"></script>
<script src="<?php echo base_url('js/backend')?>/flot-jquery-header.js"></script>  -->
<script src="<?php echo base_url('js/backend')?>/side-navigation-tag.js"></script>
<script src="<?php echo base_url('js/backend')?>/highcharts.js"></script>
